...
This is the old version of the readme, which explains how to use the sticky feet 
and make them work on the old version of the ground. 
Nowadays, the usage of wheels is not necessary anymore.
Additionally, this readme does not explain newer features of the script.
...
[Land Marauder Blueprint](Land_Marauder.blueprint)
## Legs
### Kinematic structure
![leg](leg-joint_insect.png "Leg With Joints")
...
## Lua
### Configuration
Place a Lua block and copy the [code](Walking_marauder.lua) into it.
